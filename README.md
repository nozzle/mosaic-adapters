...
- **Docs:** [core concepts](docs/core/concepts.md), [React hooks](docs/react/hooks.md), [selection topology](docs/core/selection-topology.md) (name a page's Selection graph as data), [TanStack Table integration](docs/tanstack-table/integration.md).
- **React recipes:** [connector lifecycle](docs/react/connector-lifecycle.md) (app-owned coordinator/reconnect), [data loading](docs/react/data-loading.md) (serializable source config), [filter editor](docs/react/filter-editor.md) (draft state over a FilterSet), [router persistence](docs/react/router-persistence.md), [topology recipes](docs/react/topology-recipes.md).
