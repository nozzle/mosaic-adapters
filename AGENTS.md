...
- Run `pnpm run format`, `pnpm test:lint` and `pnpm build` before commit or final handoff.
...
- For broader contributor workflow and commit conventions, see [CONTRIBUTING.md](./CONTRIBUTING.md).
